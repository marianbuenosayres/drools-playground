...
public abstract class DecorableSingleSessionCommandService 
    implements
    ...
    public DecorableSingleSessionCommandService(RuleBase ruleBase,
    ...
    public DecorableSingleSessionCommandService(Integer sessionId,
                                       RuleBase ruleBase,
                                       SessionConfiguration conf,
                                       Environment env) {
        this( sessionId,
    ...
    public DecorableSingleSessionCommandService(KieBase kbase,
    ...
    protected void initNewKnowledgeSession(KieBase kbase, KieSessionConfiguration conf) { 
        ...
        this.ksession = decorateKieSession(kbase.newKieSession( conf, this.env ));
    ...
    protected abstract KieSession decorateKieSession(KieSession newKieSession);
    ...
    protected void initExistingKnowledgeSession(Integer sessionId,
        ...
        this.ksession = decorateKieSession(this.ksession);
    ...
    private static class SynchronizationImpl
        ...
        DecorableSingleSessionCommandService service;

        public SynchronizationImpl(DecorableSingleSessionCommandService service) {
        ...
        public void afterCompletion(int status) {
            ...
            Object removedSynchronization = DecorableSingleSessionCommandService.synchronizations.remove( this.service );
