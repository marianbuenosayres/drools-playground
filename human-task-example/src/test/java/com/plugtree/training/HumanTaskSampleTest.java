...
public class HumanTaskSampleTest {
	...
	public void testLocalTaskService() throws Exception {
		...
		//create mock groups
		userGroupCallback.addUser("john", "writer");
		userGroupCallback.addUser("mary", "translator");
		userGroupCallback.addUser("BOSS", "users");
		userGroupCallback.addUser("Administrator", "writer", "translator", "users");
		//start taskService
