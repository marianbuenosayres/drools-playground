...
public class SprintManagementTest {
	...
	public void testSmallSprint() throws Exception {
        ...
        NonManagedLocalHTWorkItemHandler htHandler = new NonManagedLocalHTWorkItemHandler(ksession, taskService);
        CompilationWorkItemHandler compileHandler = new CompilationWorkItemHandler();
        DeploymentWorkItemHandler deployHandler = new DeploymentWorkItemHandler();
